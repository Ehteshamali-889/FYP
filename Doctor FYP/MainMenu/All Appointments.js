        ...
        <View style={{ display: 'flex', justifyContent: 'center', alignItems: 'center' }}>
          ...
          >
            <View style={{ backgroundColor: 'white', padding: 25, display:'flex',justifyContent:'center',alignItems:'center' }}>
              ...
              <Button mode="outlined" onPress={() => navigation.navigate('New')} style={{margin:10,marginTop:20}}>
                View All
              </Button>
            </View>
            <View style={{ backgroundColor: 'white', padding: 25, display:'flex',justifyContent:'center',alignItems:'center' }}>
              ...
              <Button mode="outlined" onPress={() => navigation.navigate('Old')} style={{margin:10,marginTop:20}}>
                View All
              </Button>
            </View>
          </View>
