...
import PaidPagination from './PaidPagination';
...
const AllPaid = () => {
    ...
    useEffect(()=>{
        const fetchData=async()=>{
            const response = await axios.get(
                "http://localhost:3010/payment/Payment/"
            );
    ...
    return (
        <>
            <h1 style={{textAlign:'center'}}>View All Paid Payments</h1>  
            <PaidList users={currentPosts} updateUsers={setUsers} />
            <PaidPagination
