  ...
  return (
    <View>
        <View style={styles.firstbox}>
            ...
            <View style={styles.subbox}>
            <Image source={require('../assets/patient.png')} style={{ width: 128, height: 128 }} />
            <Button mode='outlined' style={styles.maintext} onPress={() => navigation.navigate('AllPatients')}>View Patients</Button>
            </View>
